...
filepath = (r'C:\Users\sr528\OneDrive\Desktop\DashboardExample\Data\Console_share_')
df = []
...
headline = 'Gaming Console Marketshare in 2021'
description = '''
...
def display_graph(region, vis_type):
	...
	fig = None
	vis_title = 'Gaming Market Share in 2021'
	if vis_type == 'line':
